...
namespace WardrobeProject.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,BottomPhoto,BottomType,BottomColor")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,BottomPhoto,BottomType,BottomColor")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
