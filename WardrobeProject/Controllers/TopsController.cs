...
namespace WardrobeProject.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopPhoto,TopName,TopType,TopColor")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopPhoto,TopName,TopType,TopColor")] Top top)
        {
            if (ModelState.IsValid)
            {
