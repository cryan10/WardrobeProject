...
namespace WardrobeProject.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeType,ShoeColor")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeType,ShoeColor")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
